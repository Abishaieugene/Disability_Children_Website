...
<head>
    ...
    <title>Mother Mary School Registration Form</title>
    <style>
        body, html {
            height: 100%;
            margin: 0;
            font-family: Arial, sans-serif;
            background-image: url("${pageContext.request.contextPath}/images/motherteresanew.jpg"); /* Path to your image */
        ...
        .form-container h2 {
            color: red; /* Ensure the text is visible */
        }
...
<body>
    <div class="form-container">
        ...
        <p>For more help, contact: 9443934801</p>
    </div>
</body>
</html>
